...
const WhatsAppButton = () => {
    ...
    return (
        <a 
            ...
            className={`whatsapp-button fixed bottom-4 right-4 bg-green-500 text-white p-4 rounded-full shadow-lg flex items-center gap-2 hover:bg-green-600 transition z-50 ${isBlinking ? 'animate-pulse' : ''}`}
        >
